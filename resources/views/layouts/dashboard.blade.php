...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('dashboard_assetes') }}/images/favicon.png">
	<link rel="stylesheet" href="{{ asset('dashboard_assetes') }}/vendor/chartist/css/chartist.min.css">
    <link href="{{ asset('dashboard_assetes') }}/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link href="{{ asset('dashboard_assetes') }}/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
    <link href="{{ asset('dashboard_assetes') }}/css/style.css" rel="stylesheet">
...
<body>
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="{{ asset('dashboard_assetes') }}/images/logo.png" alt="">
                <img class="logo-compact" src="{{ asset('dashboard_assetes') }}/images/logo-text.png" alt="">
                <img class="brand-title" src="{{ asset('dashboard_assetes') }}/images/logo-text.png" alt="">
            </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                @else
                                <img src="{{ asset('dashboard_assetes') }}/images/default_profile_photo.png" class="img-fluid rounded-circle" alt="">
                                @endif
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="{{ asset('dashboard_assetes') }}/vendor/global/global.min.js"></script>
	<script src="{{ asset('dashboard_assetes') }}/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
	<script src="{{ asset('dashboard_assetes') }}/vendor/chart.js/Chart.bundle.min.js"></script>
    <script src="{{ asset('dashboard_assetes') }}/js/custom.min.js"></script>
	<script src="{{ asset('dashboard_assetes') }}/js/deznav-init.js"></script>
	<script src="{{ asset('dashboard_assetes') }}/vendor/owl-carousel/owl.carousel.js"></script>

	<!-- Chart piety plugin files -->
    <script src="{{ asset('dashboard_assetes') }}/vendor/peity/jquery.peity.min.js"></script>

	<!-- Apex Chart -->
	<script src="{{ asset('dashboard_assetes') }}/vendor/apexchart/apexchart.js"></script>

	<!-- Dashboard 1 -->
	<script src="{{ asset('dashboard_assetes') }}/js/dashboard/dashboard-1.js"></script>
	<script>
